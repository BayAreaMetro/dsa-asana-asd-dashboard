...
app.get('/', (req, res) => {
  res.json({ message: 'Data Strategy & Analytics Work Plan Dashboard API', endpoints: ['/api/dashboard', '/api/portfolio/:id'] });
});
...
app.listen(PORT, () => {
  console.log(`Data Strategy & Analytics Work Plan Dashboard running on http://localhost:${PORT}`);
